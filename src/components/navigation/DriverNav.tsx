...
export const DriverNav: React.FC = () => {
  ...
  const navItems = [
    { path: '/driver', label: t.driverNav.deliveries, icon: <MapPin className="w-5 h-5" />, end: true },
    { path: '/driver/active', label: t.driverNav.active, icon: <Navigation className="w-5 h-5" /> },
    { path: '/driver/earnings', label: t.driverNav.earnings, icon: <DollarSign className="w-5 h-5" /> },
  ];
